...
class light_control(appapi.my_appapi):
  ...
  def initialize(self):
    ...
    self.control_dict={#"switch.breakfast_room_light_switch":{"switch.breakfast_room_light_switch":{"on":"on","off":"off"}},
                       ...
                       #"switch.downstairs_hallway_light_switch":{"switch.downstairs_hallway_light_switch":{"on":"on","off":"off"}},
                       #"switch.garage_switch_2":{"switch.garage_switch_2":{"on":"on","off":"off","desc":"carriage Lights"}},
                       #"sun.sun":{"switch.garage_switch_2":{"on":"off","off":"on"},
                       #           "switch.back_patio_light_switch":{"on":"off","off":"on"}},
                       #"light.master_light_level":{"light.master_light_level":{"on":"255","off":"0","last_brightness":""}},
                       #"light.upstairs_hallway_light_level":{"light.upstairs_hallway_light_level":{"on":"255","off":"0","last_brightness":""}},
                       #"switch.attic_pulldown_light_switch":{"switch.attic_pulldown_light_switch":{"on":"delay,off,3600","off":"off"}},
                       #"device_tracker.ccox0605_ccox0605":{"switch.downstairs_hallway_light":{"on":"on","off":"ignore"},
                       #                                    "light.charlie_light_level":{"on":"ignore","off":"0","last_brightness":""},
                       #                                    "fan.charlie_fan_level":{"on":"255","off":"126","last_brightness":""}},
                       #"light.charlie_light_level":{"light.charlie_light_level":{"on":"255","off":"0","last_brightness":""}},
                       #"fan.charlie_fan_level":{"fan.charlie_fan_level":{"on":"128","off":"0","last_brightness":""}},
                       #"switch.media_room_light_switch":{"switch.media_room_light_switch":{"on":"on","off":"off"}},
                       #"fan.media_room_fan_level":{"fan.media_room_fan_level":{"on":"128","off":"0","last_brightness":""}},
                       #"input_boolean.masterishome":{"light.master_light_level":{"on":"ignore","off":"0","last_brightness":""},
                       #                                  "fan.master_fan_level":{"on":"ignore","off":"0","last_brightness":""},
                       #                                  "light.master_floor_light_level":{"on":"ignore","off":"0","last_brightness":""},
                       #                                  "switch.master_toilet_fan":{"on":"ignore","off":"0"},
                       #                                  "switch.master_toilet_light":{"on":"ignore","off":"0"},
                       #                                  "switch.master_vanity_switch":{"on":"ignore","off":"0"},
                       #                                  "switch.downstairs_hallway_light_switch":{"on":"on","off":"off"}},
                       #"input_boolean.spot":{"switch.downstairs_hallway_light_switch":{"on":"on","off":"off"},
                       #                      "switch.kitchen_overhead_switch":{"on":"on","off":"off"},
                       #                      "light.stairway_lights_level":{"on":"on","off":"off"},
                       #                      "light.office_lights_level":{"on":"on","off":"off"},
                       #                      "switch.front_door_light_switch":{"on":"on","off":"off"}},
                       ...
                       #"input_boolean.master_bath_high_humidity":{"switch.master_bath_fan_switch":{"on":"on","off":"off"}},
                       #"light.master_floor_light_level":{"light.master_floor_light_level":{"on":"128","off":"0","last_brightness":""}},
                       #"switch.sam_toilet_light":{"switch.sam_toilet_fan":{"on":"delay,on,300","off":"delay,off,300"}},
                       #"time":{"19:00:00":{"switch.front_porch_light_switch":{"state":"on","dow":"m,t,w,th,f"}},
                       #        "23:30:00":{"switch.back_patio_light_switch":{"state":"off","dow":"all"}}},
                       #"binary_sensor.ring_front_door_ding":{"switch.front_door_light_switch":{"on":"on","off":"delay,off,900"}} }

    self.exception_dict={#"light.sam_room_light_level":["input_boolean.samishomeoverride"],
                        ...
                        # "light.charlie_light_level":["input_boolean.charlieishomeoverride"],
                        # "light.master_floor_light_level":["input_boolean.masterishomeoverride"],
                         #"light.master_light_level":["input_boolean.masterishomeoverride"],
                         #"light.office_lights":["input_boolean.partyoverride"],
                         #"light.shed_flood_light":["input_boolean.partyoverride"],
                         #"light.stairway_lights_level":["input_boolean.partyoverride","input_boolean.samishomeoverride",
                         #                               "input_boolean.charlieishomeoverride","input_boolean.guestishomeoverride"],
                         #"light.den_light_level":["input_boolean.partyoverride","input_boolean.samishomeoverride",
                         #                       "input_boolean.charlieishomeoverride","input_boolean.guestishomeoverride"],
                         #"switch.back_patio_light_switch":["input_boolean.partyoverride"],
                         #"switch.breakfast_room_light_switch":["input_boolean.partyoverride"],
                         #"switch.downstairs_hallway_light_switch":["input_boolean.partyoverride","input_boolean.samishomeoverride",
                         #                                "input_boolean.charlieishomeoverride","input_boolean.guestishomeoverride"],
                         #"switch.front_door_light_switch":["input_boolean.partyoverride"],
                         #"switch.garage_switch_3":["input_boolean.partyoverride"],
                         #"switch.guest_room_light_switch":["input_boolean.partyoverride","input_boolean.guestishomeoverride"],
                         #"switch.half_bath_light_switch":["input_boolean.partyoverride"],
                         #"switch.house_flood_lights_switch":["input_boolean.partyoverride"],
                         #"switch.media_room_light_switch":["input_boolean.partyoverride"]}
