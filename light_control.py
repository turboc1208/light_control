...
#    return 0
    ...
    self.control_dict={"switch.breakfast_room_light":{"switch.breakfast_room_light":{"on":"on","off":"off"}},
                       ...
                       "input_boolean.spot":{"switch.downstairs_hallway_light":{"on":"on","off":"off"},
                                             "switch.kitchen_overhead_light":{"on":"on","off":"off"},
                                             "light.stairway_light_switch":{"on":"on","off":"off"},
                                             "switch.front_door_light":{"on":"on","off":"off"}},
